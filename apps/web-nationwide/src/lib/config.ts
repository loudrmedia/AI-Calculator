/**
 * Application configuration - Nationwide version
 */
...
export const CONFIG = {
  ...
  // TODO(Nationwide): This is still the CA (213) intake number, copied as a placeholder.
  // Update to the real nationwide intake number before launch.
