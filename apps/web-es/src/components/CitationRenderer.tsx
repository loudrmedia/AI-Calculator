    ...
    <div className="citations-container">
      <div className="citations-header">
        ...
        <span className="model-version">
          Modelo v{MODEL_VERSION} • Datos consultados el {DATA_ACCESS_DATE}
        </span>
      </div>
      
      <p className="citations-intro">
        Cada cifra de este estimado proviene de fuentes públicas.
        Haga clic en cualquier enlace para verificar los datos.
      </p>
...
export function AllSourcesTable() {
  ...
  return (
    <div className="sources-table-container">
      <h3>Fuentes de Datos Completas</h3>
      <p className="sources-intro">
        Todos los datos fueron consultados y están vigentes al {DATA_ACCESS_DATE}. Haga clic en
        cualquier enlace para verificar.
      </p>
        ...
        {sourcesList.map((source, index) => (
          <div key={source.id} className="source-card">
            ...
            <div className="source-usage">
              <strong>Uso:</strong> {source.allowedUsage}
            </div>
          </div>
        ))}
      </div>
