...
const ACCIDENT_TYPES: { value: AccidentType; label: string; icon: string; badge?: string }[] = [
  { value: 'car_accident', label: 'Accidente de Auto', icon: '🚗', badge: 'Más común' },
  { value: 'motorcycle_accident', label: 'Accidente de Motocicleta', icon: '🏍️' },
  { value: 'truck_accident', label: 'Accidente de Camión', icon: '🚛' },
  { value: 'bicycle_accident', label: 'Accidente de Bicicleta', icon: '🚲' },
  { value: 'pedestrian_accident', label: 'Accidente de Peatón', icon: '🚶' },
...
export function AccidentTypeStep() {
  ...
  return (
    <div>
      <h2 className="step-title">¿Qué tipo de accidente sufrió?</h2>
