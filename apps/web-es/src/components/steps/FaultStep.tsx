...
const FAULT_OPTIONS: { value: FaultStatus; label: string; icon: string }[] = [
  { value: 'not_at_fault', label: 'No, no fue mi culpa', icon: '🙅' },
  { value: 'partial_fault', label: 'No sé quién tuvo la culpa', icon: '🤷' },
  { value: 'at_fault', label: 'Sí, fue mi culpa', icon: '🙋' },
];
...
export function FaultStep() {
  ...
  return (
    <div>
      <h2 className="step-title">¿Tuvo usted la culpa del accidente?</h2>
